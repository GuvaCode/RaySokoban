...
begin
 ...
 // SetTargetFPS(60);
  ...
  GuiLoadStyle(GetAppDir('data/gui/cyber.rgs'));
  LoadingModel;
  animsCount := 0;
  animIndex := 0;
  CurrentFrame := 0;
  modelAnimations := LoadModelAnimations(GetAppDir('data/models/robot.glb'), @animsCount);
...
begin
  PlayerRobot := LoadModel(GetAppDir('data/models/robot.glb'));
  Grass :=  LoadModel(GetAppDir('data/models/Block_Dirt.gltf'));
  DoIn :=  LoadModel(GetAppDir('data/models/Block_Diamond.gltf'));
  Brick :=  LoadModel(GetAppDir('data/models/Cube_Crate.gltf'));
  BoxOut :=  LoadModel(GetAppDir('data/models/Cube_Question.gltf'));
  BoxIn :=  LoadModel(GetAppDir('data/models/Cube_Exclamation.gltf'));

  Tree1 := LoadModel(GetAppDir('data/models/DeadTree_1.gltf'));
  Tree2 := LoadModel(GetAppDir('data/models/DeadTree_2.gltf'));

  Mushroom := LoadModel(GetAppDir('data/models/Mushroom.gltf'));
  Crystal := LoadModel(GetAppDir('data/models/Crystal_Small.gltf'));
...
begin
  ...
  begin
    TakeScreenshot('soko'+FloatToStr(GetTime)+'.png');
  end;
end;
